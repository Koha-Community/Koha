...
subtest
    'Perform a system preferences search for "log", and try to expand/collapse both "Policy" sections that appear' =>
    sub {
    ...
    is(
        $first_policy_section_toggle_elt->get_attribute( 'class', 1 ), 'expanded',
        'The first "Policy" section (under "Accounting") is currently expanded'
    );
    ...
    is(
        $first_policy_section_toggle_elt->get_attribute( 'class', 1 ), 'collapsed',
        'The first "Policy" section (under "Accounting") is now collapsed'
    );
    ...
    is(
        $first_policy_section_toggle_elt->get_attribute( 'class', 1 ), 'expanded',
        'The first "Policy" section (under "Accounting") is back to the expanded state'
    );
    ...
    is(
        $second_policy_section_toggle_elt->get_attribute( 'class', 1 ), 'expanded',
        'The second "Policy" section (under "Acquisitions") is currently expanded'
    );
    ...
    is(
        $second_policy_section_toggle_elt->get_attribute( 'class', 1 ), 'collapsed',
        'The second "Policy" section (under "Acquisitions") is now collapsed'
    );
    ...
    is(
        $second_policy_section_toggle_elt->get_attribute( 'class', 1 ), 'expanded',
        'The second "Policy" section (under "Acquisitions") is back to the expanded state'
    );
