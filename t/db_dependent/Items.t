...
subtest 'GetHiddenItemnumbers tests' => sub {
    ...
    is( $hidden[0], $item1_itemnumber, "wthdrawn=1 is hidden");
    ...
    is_deeply( \@hidden, \@itemnumbers, "wthdrawn=1 and wthdrawn=0 hidden");
    ...
    @hidden = GetHiddenItemnumbers( @items );
    ok( scalar @hidden == 2, "Two items hidden");
    is_deeply( \@hidden, \@itemnumbers, "wthdrawn=1 and homebranch=MPL hidden");
