...
is(
    Koha::ClassSortRules->search->count, $nb_of_class_sort_rules + 2,
    'The 2 classification sorters should have been added'
);

my $retrieved_cs_1 = Koha::ClassSortRules->find( $new_cs_1->class_sort_rule );
is(
    $retrieved_cs_1->description, $new_cs_1->description,
    'Find a sorter by class_sort_rule should return the correct source'
);
