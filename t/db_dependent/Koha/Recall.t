...
is(
    $recall1->library->branchname, Koha::Libraries->find($branch1)->branchname,
    "Recall library relationship correctly linked"
);
...
is(
    t::lib::Dates::compare( $expirationdate, $expected_expirationdate ), 0,
    "Expiration date calculated based on system preference as no circulation rules are set"
);
...
is(
    t::lib::Dates::compare( $expirationdate, $expected_expirationdate ), 0,
    "Expiration date calculated based on circulation rules"
);
