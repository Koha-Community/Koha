...
subtest 'Tests with preferences' => sub {
    ...
    is(
        C4::Context->preference("SillyPreference"), 'thing1',
        "Retrieved syspref (value='thing1') successfully with default behavior"
    );
    ...
    is(
        C4::Context->preference("SillyPreference"), 'thing2',
        "Retrieved syspref (value='thing2') successfully with disabled cache"
    );
    ok( $trace_read, 'Retrieved syspref from database' );
    $trace_read = q{};
    ...
    is(
        C4::Context->preference("SillyPreference"), 'thing3',
        "Retrieved syspref (value='thing3') successfully with disabled cache"
    );
    ok( $trace_read, 'Retrieved syspref from database' );
    $trace_read = q{};
    ...
    is(
        C4::Context->preference("SillyPreference"), 'thing3',
        "Retrieved syspref (value='thing3') successfully from cache"
    );
    ...
    C4::Context->clear_syspref_cache();
    is(
        C4::Context->preference("SillyPreference"), 'thing4',
        "Retrieved syspref (value='thing4') successfully after clearing cache"
    );
    ok( $trace_read, 'Retrieved syspref from database' );
    $trace_read = q{};
    ...
    is(
        C4::Context->preference("SillyPreference"), 'thing4',
        "Retrieved syspref (value='thing4') successfully from cache"
    );
    is( $trace_read, q{}, 'Did not retrieve syspref from database' );
    $trace_read = q{};
