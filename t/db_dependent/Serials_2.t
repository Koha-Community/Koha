...
is(
    C4::Serials::can_edit_subscription($subscription_from_my_branch), 0,
    "cannot edit a subscription without userenv set"
);
is(
    C4::Serials::can_claim_subscription($subscription_from_my_branch), 0,
    "cannot edit a subscription without userenv set"
);
...
is(
    C4::Serials::can_edit_subscription($subscription_from_my_branch), 1,
    "User can edit a subscription with an empty branchcode"
);
is(
    C4::Serials::can_claim_subscription($subscription_from_my_branch), 1,
    "User can edit a subscription with an empty branchcode"
);
...
is(
    C4::Serials::can_edit_subscription($subscription_from_another_branch), 1,
    "With IndependentBranches, superlibrarian can edit a subscription from another branch"
);
is(
    C4::Serials::can_show_subscription($subscription_from_my_branch), 1,
    "With IndependentBranches, superlibrarian can show a subscription from his branch"
);
is(
    C4::Serials::can_show_subscription($subscription_from_another_branch), 1,
...
is(
    C4::Serials::can_claim_subscription($subscription_from_another_branch), 1,
...
is(
    C4::Serials::can_edit_subscription($subscription_from_another_branch), 0,
...
is(
    C4::Serials::can_show_subscription($subscription_from_another_branch), 0,
...
is(
    C4::Serials::can_claim_subscription($subscription_from_another_branch), 0,
