...
INSERT IGNORE INTO `marc_subfield_structure` (`tagfield`, `tagsubfield`, `liblibrarian`, `libopac`, `repeatable`, `mandatory`, `kohafield`, `tab`, `authorised_value`, `authtypecode`, `value_builder`, `isurl`, `hidden`, `frameworkcode`, `seealso`, `link`, `defaultvalue`) VALUES
		...
		('440', 'a', 'Titolo', 'Titolo', 0, 0, 'biblio.seriestitle', 4, '', 'UNIF_TITLE', '', NULL, -6, '', '''440n'',''440p'',''490a'',''830a'',''830n'',''830p'',''899a''', '', NULL),
		('440', 'n', 'Numero di parte/sezione dell\'opera', 'Numero di parte/sezione dell\'opera', 1, 0, 'biblioitems.number', 4, '', '', '', NULL, -6, '', '', '', NULL),
		('440', 'p', 'Nome di parte/sezione dell\'opera', 'Nome di parte/sezione dell\'opera', 1, 0, '', 4, '', '', '', NULL, -6, '', '', '', NULL),
		('440', 'v', 'Numero del volume/designazione di sequenza', 'Numero del volume/designazione di sequenza', 0, 0, 'biblioitems.volume', 4, '', '', '', NULL, -6, '', '', '', NULL),
		('440', 'w', 'Numero di controllo bibliografico', 'Numero di controllo bibliografico', 1, 0, '', 4, '', '', '', NULL, -6, '', '', '', NULL),
		('440', 'x', 'ISSN (International Standard Serial Number)', 'ISSN (International Standard Serial Number)', 0, 0, '', 4, '', '', '', NULL, -6, '', '', '', NULL),
		('490', '3', 'Materiale specificato', 'Materiale specificato', 0, 0, '', 4, '', '', '', NULL, 0, '', '', '', NULL),
		...
		('490', 'a', 'Formulazione della serie', 'Formulazione della serie', 1, 0, 'biblioitems.seriestitle', 4, '', '', '', NULL, 0, '', '', '', NULL),
		...
		('490', 'v', 'Numero del volume/designazione di sequenza', 'Numero del volume/designazione di sequenza', 1, 0, 'biblioitems.volume', 4, '', '', '', NULL, 0, '', '', '', NULL),
		('490', 'x', 'ISSN (International Standard Serial Number)', 'ISSN (International Standard Serial Number)', 1, 0, '', 4, '', '', '', NULL, 0, '', '', '', NULL),
