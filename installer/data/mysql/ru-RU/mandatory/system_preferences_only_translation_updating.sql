...
UPDATE systempreferences SET explanation='Если включено, то повышает безопасность между библиотеками' WHERE variable='IndependantBranches';	
...
-- UPDATE systempreferences SET explanation='' WHERE variable='NoZebraIndexes';
-- 	
...
-- 	 if ON, enables the librarian to choose when they want to check out a notForLoan regular item
