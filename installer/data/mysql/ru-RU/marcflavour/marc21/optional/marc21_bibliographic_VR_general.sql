...
INSERT INTO  marc_subfield_structure (frameworkcode, authtypecode, tagfield, tagsubfield, mandatory, repeatable, liblibrarian, libopac, tab, hidden, kohafield, authorised_value, value_builder, isurl, seealso, link, defaultvalue) VALUES
 ...
 ('VR', '', '245', 'b', 0, 0, 'Продолж. заглавия', '',                  2, 0, 'biblio.subtitle', '', '', NULL, '', '', NULL),
...
INSERT INTO  marc_subfield_structure (frameworkcode, authtypecode, tagfield, tagsubfield, mandatory, repeatable, liblibrarian, libopac, tab, hidden, kohafield, authorised_value, value_builder, isurl, seealso, link, defaultvalue) VALUES
 ...
 ('VR', 'UNIF_TITLE', '440', 'a', 0, 0, 'Серия', '',                    4, -6, 'biblio.seriestitle', '', '', NULL, '\'440n\',\'440p\',\'490a\',\'830a\',\'830n\',\'830p\',\'899a\'', '', NULL),
 ('VR', '', '440', 'n', 0, 1, 'Номер части', '',                        4, -6, 'biblioitems.number', '', '', NULL, '', '', NULL),
 ('VR', '', '440', 'p', 0, 1, 'Название части', '',                     4, -6, '', '', '', NULL, '', '', NULL),
 ('VR', '', '440', 'v', 0, 0, '№ тома', '',                             4, -6, 'biblioitems.volume', '', '', NULL, '', '', NULL),
 ('VR', '', '440', 'x', 0, 0, 'ISSN серии', '',                         4, -6, '', '', '', NULL, '', '', NULL);
...
INSERT INTO  marc_subfield_structure (frameworkcode, authtypecode, tagfield, tagsubfield, mandatory, repeatable, liblibrarian, libopac, tab, hidden, kohafield, authorised_value, value_builder, isurl, seealso, link, defaultvalue) VALUES
 ...
 ('VR', '', '490', 'a', 0, 1, 'Заглавие серии', '',                     4, 0, 'biblioitems.seriestitle', '', '', NULL, '', '', NULL),
 ('VR', '', '490', 'l', 0, 0, 'Library of Congress call number', 'Library of Congress call number', 4, -6, '', '', '', NULL, '', '', NULL),
 ('VR', '', '490', 'v', 0, 1, '№ тома', '',                             4, 0, 'biblioitems.volume', '', '', NULL, '', '', NULL),
 ('VR', '', '490', 'x', 0, 0, 'ISSN серии', '',                         4, 0, '', '', '', NULL, '', '', NULL);
