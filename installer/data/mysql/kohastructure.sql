...
CREATE TABLE `branches` ( -- information about your libraries or branches are stored here
  ...
  `pickup_location` tinyint(1) not null default 1, -- can library act as a pickup location
...
CREATE TABLE `issuingrules` ( -- circulation and fine rules
  ...
  `hold_max_pickup_delay` smallint(6), -- hold max pickup delay in days
  `hold_expiration_charge` decimal(28,6) default NULL, -- hold expiration charge (amount)
...
--
-- Table structure for table `batch_overlay_reports`
--

DROP TABLE IF EXISTS `batch_overlay_reports`;
...
--
-- Table structure for table `batch_overlay_diff`
--

DROP TABLE IF EXISTS `batch_overlay_diff`;
...
--
-- Table structure for table `batch_overlay_diff_header`
--

DROP TABLE IF EXISTS `batch_overlay_diff_header`;
CREATE TABLE `batch_overlay_diff_header` ( -- Stores headers of the records participating in the overlaying
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `bodh_bodi_1` FOREIGN KEY (`batch_overlay_diff_id`) REFERENCES `batch_overlay_diff` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
-- Table structure for table `vetuma_transaction`
--

DROP TABLE IF EXISTS `vetuma_transaction`;
...
--
-- Table structure for table `vetuma_transaction_accountlines_link`
--

DROP TABLE IF EXISTS `vetuma_transaction_accountlines_link`;
