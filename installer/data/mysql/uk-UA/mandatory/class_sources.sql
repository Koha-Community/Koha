...
INSERT INTO `class_sources` (`cn_source`, `description`, `used`, `class_sort_rule`, `class_split_rule`) VALUES
 ...
 ('ccpgq',   'Cadre de classement des publication gouvernementales',             0, 'generic', 'generic', 'generic'),
 ('clc',     'Китайська система бібліотечної класифікації',                      0, 'generic', 'generic', 'generic'),
