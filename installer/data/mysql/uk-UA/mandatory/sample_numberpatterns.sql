...
VALUES
    ('Номер', 1, 'Простий метод нумерації', 'No. {X}',
    'Номер', 1, 1, 99999, 1, NULL,
    NULL, NULL, NULL, NULL, NULL, NULL,
    NULL, NULL, NULL, NULL, NULL, NULL),

    ('Том, номер, випуск', 2, 'Том X, № Y, випуск Z', 'Том {X}, № {Y}, вип. {Z}',
    'Том', 1, 48, 99999, 1, NULL,
    'Номер', 1, 4, 12, 1, NULL,
    'Випуск', 1, 1, 4, 1, NULL),

    ('Том, номер', 3, 'Том X, № Y', 'Том {X}, № {Y}',
    'Том', 1, 12, 99999, 1, NULL,
    'Номер', 1, 1, 12, 1, NULL,
    NULL, NULL, NULL, NULL, NULL, NULL),

    ('За порами року', 4, 'Пора року, рік', '{X} {Y}',
    'Пора року', 1, 1, 3, 0, 'season',
    'Рік', 1, 4, 99999, 1, NULL,
    NULL, NULL, NULL, NULL, NULL, NULL);

-- From it-IT - to translate
-- INSERT INTO subscription_numberpatterns
