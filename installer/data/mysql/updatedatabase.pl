...
$DBversion = "3.22.13.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 3.22.13)\n";
    SetVersion($DBversion);
}

$DBversion = "3.22.14.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 3.22.14)\n";
    SetVersion($DBversion);
}

$DBversion = "3.22.15.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 3.22.15)\n";
    SetVersion($DBversion);
}

$DBversion = "3.22.16.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 3.22.16)\n";
    SetVersion($DBversion);
}
...
$DBversion = "3.22.17.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 3.22.17)\n";
    SetVersion($DBversion);
}

$DBversion = "3.22.18.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 3.22.18)\n";
    SetVersion($DBversion);
}

$DBversion = "3.22.19.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 3.22.19)\n";
    SetVersion($DBversion);
}

$DBversion = "3.22.20.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 3.22.20)\n";
    SetVersion($DBversion);
}
