...
$DBversion = '17.11.15.000';
if( CheckVersion( $DBversion ) ) {
    SetVersion( $DBversion );
    print "Upgrade to $DBversion done (17.11.15 release)\n";
}

$DBversion = '17.11.16.000';
if( CheckVersion( $DBversion ) ) {
    SetVersion( $DBversion );
    print "Upgrade to $DBversion done (17.11.16 release)\n";
}

$DBversion = '17.11.17.000';
if( CheckVersion( $DBversion ) ) {
    SetVersion( $DBversion );
    print "Upgrade to $DBversion done (17.11.17 release)\n";
}

$DBversion = '17.11.18.000';
if( CheckVersion( $DBversion ) ) {
    SetVersion( $DBversion );
    print "Upgrade to $DBversion done (17.11.18 release)\n";
}
