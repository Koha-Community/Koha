...
$DBversion = "3.14.09.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (3.14.9 release)\n";
    SetVersion($DBversion);
}
...
$DBversion = "3.14.13.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (3.14.13 release)\n";
    SetVersion($DBversion);
}

$DBversion = "3.14.14.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (3.14.14 release)\n";
    SetVersion($DBversion);
}
...
$DBversion = "3.14.15.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (3.14.15 release)\n";
    SetVersion($DBversion);
}

$DBversion = "3.14.16.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (3.14.16 release)\n";
    SetVersion($DBversion);
}

$DBversion = "3.14.17.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (3.14.17 release)\n";
    SetVersion($DBversion);
}
