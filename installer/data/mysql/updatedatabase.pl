...
$DBversion = "3.10.08.000";
if ( C4::Context->preference("Version") < TransformToNum($DBversion) ) {
    print "Upgrade to $DBversion done (3.10.8 release)\n";
    SetVersion($DBversion);
}

$DBversion = "3.10.09.000";
if ( C4::Context->preference("Version") < TransformToNum($DBversion) ) {
    print "Upgrade to $DBversion done (3.10.9 release)\n";
    SetVersion($DBversion);
}
...
$DBversion = "3.10.11.000";
if ( C4::Context->preference("Version") < TransformToNum($DBversion) ) {
    print "Upgrade to $DBversion done (3.10.11 release)\n";
    SetVersion($DBversion);
}

$DBversion = "3.10.12.000";
if ( C4::Context->preference("Version") < TransformToNum($DBversion) ) {
    print "Upgrade to $DBversion done (3.10.12 release)\n";
    SetVersion($DBversion);
}

$DBversion = "3.10.13.000";
if ( C4::Context->preference("Version") < TransformToNum($DBversion) ) {
    print "Upgrade to $DBversion done (3.10.13 release)\n";
    SetVersion($DBversion);
}
