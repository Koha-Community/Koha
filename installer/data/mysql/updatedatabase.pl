...
$DBversion = '19.05.01.000';
if( CheckVersion( $DBversion ) ) {
    SetVersion( $DBversion );
    print "Upgrade to $DBversion done (19.05.01 release)\n";
}

$DBversion = '19.05.01.001';
if ( CheckVersion( $DBversion ) ) {
...
$DBversion = '19.05.07.004'; # will be replaced by the RM
if( CheckVersion( $DBversion ) ) {
...
$DBversion = "19.05.10.000";
if ( CheckVersion($DBversion) ) {
        print "Upgrade to $DBversion done (19.05.10 release)\n";
            SetVersion ($DBversion);
}

$DBversion = '19.05.10.001';
if( CheckVersion( $DBversion ) ) {
...
$DBversion = "19.05.14.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (19.05.14 release)\n";
    SetVersion ($DBversion);
}
...
$DBversion = "19.05.15.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (19.05.15 release)\n";
    SetVersion ($DBversion);
}

$DBversion = "19.05.16.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (19.05.16 release)\n";
    SetVersion ($DBversion);
}

$DBversion = '19.05.16.001';
if( CheckVersion( $DBversion ) ) {
...
if( CheckVersion( $DBversion ) ) {
    ...
    if ( !foreign_key_exists( 'aqbudgets', 'aqbudgetperiods_ibfk_1' ) ) {
        ...
        |);
        print "Upgrade to $DBversion done (Bug 18050 - Add FK constraint on aqbudgets.budget_period_id$message)\n";
        SetVersion( $DBversion );
    } else {
...
$DBversion = "19.05.17.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (19.05.17 release)\n";
    SetVersion ($DBversion);
}
