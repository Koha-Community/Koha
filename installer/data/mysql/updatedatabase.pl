...
$DBversion = "3.08.14.000";
if ( C4::Context->preference("Version") < TransformToNum($DBversion) ) {
    print "Upgrade to $DBversion (3.8.14 release) done\n";
    SetVersion($DBversion);
}

$DBversion = "3.08.15.000";
if ( C4::Context->preference("Version") < TransformToNum($DBversion) ) {
    print "Upgrade to $DBversion (3.8.15 release) done\n";
    SetVersion($DBversion);
}

$DBversion = "3.08.16.000";
if ( C4::Context->preference("Version") < TransformToNum($DBversion) ) {
    print "Upgrade to $DBversion (3.8.16 release) done\n";
    SetVersion($DBversion);
}
...
$DBversion = "3.08.19.000";
if ( C4::Context->preference("Version") < TransformToNum($DBversion) ) {
    print "Upgrade to $DBversion done (3.8.19 release)\n";
    SetVersion($DBversion);
}

$DBversion = "3.08.20.000";
if ( C4::Context->preference("Version") < TransformToNum($DBversion) ) {
    print "Upgrade to $DBversion done (3.8.20 release)\n";
    SetVersion($DBversion);
}

$DBversion = "3.08.21.000";
if ( C4::Context->preference("Version") < TransformToNum($DBversion) ) {
    print "Upgrade to $DBversion done (3.8.21 release)\n";
    SetVersion($DBversion);
}

$DBversion = "3.08.22.000";
if ( C4::Context->preference("Version") < TransformToNum($DBversion) ) {
    print "Upgrade to $DBversion done (3.8.22 release)\n";
    SetVersion($DBversion);
}
...
$DBversion = "3.08.24.000";
if ( C4::Context->preference("Version") < TransformToNum($DBversion) ) {
    print "Upgrade to $DBversion done (3.8.24 release)\n";
    SetVersion($DBversion);
}
