...
$DBversion = "3.16.05.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (3.16.5 release)\n";
    SetVersion ($DBversion);
}
...
$DBversion = "3.16.08.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (3.16.8 release)\n";
    SetVersion ($DBversion);
}
...
$DBversion = "3.16.09.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (3.16.9 release)\n";
    SetVersion ($DBversion);
}

$DBversion = "3.16.10.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (3.16.10 release)\n";
    SetVersion ($DBversion);
}
...
$DBversion = "3.16.12.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (3.16.12 release)\n";
    SetVersion ($DBversion);
}

$DBversion = "3.16.13.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (3.16.13 release)\n";
    SetVersion ($DBversion);
}
