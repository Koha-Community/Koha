...
$DBversion = '3.02.06.000';
if (C4::Context->preference("Version") < TransformToNum($DBversion)) {
    print "Upgrade to $DBversion done (Incrementing version for 3.2.6 release. See release notes for details.)\n";
    SetVersion ($DBversion);
}
...
if (C4::Context->preference("Version") < TransformToNum($DBversion)) {
    print "Upgrade to $DBversion done (Incrementing version for 3.2.7 release. See release notes for details.)\n";
    SetVersion ($DBversion);
}
...
$DBversion = '3.02.08.000';
if (C4::Context->preference("Version") < TransformToNum($DBversion)) {
    print "Upgrade to $DBversion done (Incrementing version for 3.2.8 release. See release notes for details.)\n";
    SetVersion ($DBversion);
}
...
$DBversion = '3.02.11.000';
if (C4::Context->preference("Version") < TransformToNum($DBversion)) {
    print "Upgrade to $DBversion done (Incrementing version for 3.2.11 release. See release notes for details.)\n";
    SetVersion ($DBversion);
}
