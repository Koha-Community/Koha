...
$DBversion = "3.04.06.000";
if (C4::Context->preference("Version") < TransformToNum($DBversion)) {
    print "Upgrade to $DBversion done (Incrementing version for 3.4.6 release. See release notes for details.)\n";
    SetVersion ($DBversion);
}

$DBversion = "3.04.07.000";
if (C4::Context->preference("Version") < TransformToNum($DBversion)) {
    print "Upgrade to $DBversion done (Incrementing version for 3.4.7 .release. See release notes for details.)\n";
    SetVersion ($DBversion);
}

$DBversion = "3.04.07.001";
if (C4::Context->preference("Version") < TransformToNum($DBversion)) {
...
$DBversion = "3.04.08.000";
if (C4::Context->preference("Version") < TransformToNum($DBversion)) {
    print "Upgrade to $DBversion done (Incrementing version for 3.4.8 release. See release notes for details.)\n";
    SetVersion ($DBversion);
}

$DBversion = "3.04.08.001";
if (C4::Context->preference("Version") < TransformToNum($DBversion)) {
