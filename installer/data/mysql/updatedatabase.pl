...
$DBversion = "18.11.12.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (18.11.12 release)\n";
        SetVersion ($DBversion);
}

$DBversion = "18.11.13.000";
if ( CheckVersion($DBversion) ) {
        print "Upgrade to $DBversion done (18.11.13 release)\n";
            SetVersion ($DBversion);
}
...
$DBversion = "18.11.14.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (18.11.14 release)\n";
        SetVersion ($DBversion);
}

$DBversion = "18.11.15.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (18.11.15 release)\n";
        SetVersion ($DBversion);
}

$DBversion = "18.11.15.001";
if( CheckVersion( $DBversion ) ) {
    $dbh->do(qq{
...
$DBversion = "18.11.16.000";
if ( CheckVersion($DBversion) ) {
   print "Upgrade to $DBversion done (18.11.16 release)\n";
       SetVersion ($DBversion);
}
