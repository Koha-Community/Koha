...
This method returns the mapping for representing a Koha::Item::Transfer object on the API.
...
sub to_api_mapping {
    return {
        ...
        itemnumber        => 'item_id',
        daterequested     => 'requested_date',
        datesent          => 'sent_date',
        datearrived       => 'arrived_date',
        datecancelled     => 'cancellation_date',
