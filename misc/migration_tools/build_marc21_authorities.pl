...
my $itemfield = '852'; # enter the TAG number where your items are stored.

my %whattodo = (
	# authority code (the one you've choosen (or will choose) in Koha >> parameters >> thesaurus structure >> add)
	PNAME 	=>	{	taglist	=> "100|600|700|800|900",
				key	=> "a|b|c|q|d",
				other	=> "1|2|4|5|6|7|8|0|e|f|g|h|i|j|k|l|m|n|o|p|r|s|t|u|v|w|x|y|z",
				authtag => "100",
			},
	CNAME   =>      {       taglist => "110|610|710|810|910",
                                key	=> "a|b|c|d",
                                other   => "1|2|4|5|6|7|8|0|e|f|g|h|i|j|k|l|m|n|o|p|r|s|t|u|v|w|x|y|z",
                                authtag => "110",
                        },
	MNAME   =>      {       taglist => "111|611|711|811|911",
                                key     => "a|b|c|q|d",
                                other   => "1|2|4|5|6|7|8|0|e|f|g|h|i|j|k|l|m|n|o|p|r|s|t|u|v|w|x|y|z",
                                authtag => "111",
                        },
	GNAME   =>      {       taglist => "151|651|751|851",
                                key	=> "a|b|c|q|d",
                                other   => "1|2|4|5|6|7|8|0|e|f|g|h|i|j|k|l|m|n|o|p|r|s|t|u|v|w|x|y|z",
                                authtag => "151",
                        },
	#TITLE   =>      {       taglist => "130|210|211|212|222|240|243|400|410|411|440|490|630|730|830|930|940|980|981|982|983",
	TITLE   =>      {       taglist => "130|210|211|212|222|240|243|440|490|630|730|830|930|940|980|981|982|983",
                                key	=> "a",
                                other   => "0|1|2|4|5|6|7|8|b|c|d|e|f|g|h|i|j|k|l|m|n|o|p|q|r|s|t|u|v|w|x|y|z",
                                authtag => "130",
                        },
	GENRE   =>      {       taglist => "655|656|657|658",
                                key	=> "a|z|x|y|v",
                                other   => "0|1|2|4|5|7|8|b|c|d|e|f|g|h|i|j|k|l|m|n|o|p|q|r|s|t|u|w",
                                authtag => "155",
                        },
	TTERM   =>      {       taglist => "650",
                                key	=> "a|z|x|y|v",
                                other   => "0|1|2|4|5|6|7|8|b|c|d|e|f|g|h|i|j|k|l|m|n|o|p|q|r|s|t|u|w",
                                authtag => "150",
                        },
	CTERM   =>      {       taglist => "648",
                                key	=> "a|z|x|y|v",
